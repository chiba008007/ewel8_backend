...
class CSVEAIAController extends TestController
{
    //
    public function getEAIa(Request $request)
    {
        ...
        try {
            ...
            foreach ($eaiaList as $eaia) {
                $eaiaByExamId[$eaia->exam_id] = $eaia;
            }
            ...
            foreach ($exams as $key => $exam) {
                ...
                $result[$key] = [
                    ...
                    // Vue側のvalue.eaiaと合わせる
                    'eaia' => $eaiaByExamId[$exam->id] ?? null,
                ];
            }
