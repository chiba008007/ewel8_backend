...
{
    //
    public function setWeightMaster(Request $request)
    {
        try {
    ...
    public function editWeightMaster(Request $request)
    {
        try {
    ...
    public function editStatusWeightMaster(Request $request)
    {
        try {
            $weightid = $request->weightid;
            $customer_id = $request->id;
    ...
    public function getWeightMasterDetail(Request $request)
    {
        $weightid = $request->weightid;
