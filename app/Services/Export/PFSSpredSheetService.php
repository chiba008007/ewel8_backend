...
class PFSSpredSheetService
{
    ...
    public function createTitle($sheet, $sheet1, $lastColIndex, $code)
    {
        ...
        if ($code->weight1) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus5.$fiveRow);
        }
        ...
        if ($code->weight2) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus6.$fiveRow);
        }
        ...
        if ($code->weight3) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus7.$fiveRow);
        }
        ...
        if ($code->weight4) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus8.$fiveRow);
        }
        ...
        if ($code->weight5) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus9.$fiveRow);
        }
        ...
        if ($code->weight6) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus10.$fiveRow);
        }
        ...
        if ($code->weight7) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus11.$fiveRow);
        }
        ...
        if ($code->weight8) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus12.$fiveRow);
        }
        ...
        if ($code->weight9) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus13.$fiveRow);
        }
        ...
        if ($code->weight10) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus14.$fiveRow);
        }
        ...
        if ($code->weight11) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus15.$fiveRow);
        }
        ...
        if ($code->weight12) {
            $sheet->duplicateStyle($sheet1->getStyle('Q5'), $nextColLetter_plus16.$fiveRow);
        }
    }
